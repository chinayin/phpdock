...
# USAGE EXAMPLE:
# Install docker-compose and docker-sync: ./dock.sh install
# Start sync and services with nginx and phpfpm: ./dock.sh up nginx php-fpm
# Stop containers and sync: ./dock.sh stop
...
display_options() {
  ...
  printf "\t\t\t Opens bash on the workspace with user.\n"
